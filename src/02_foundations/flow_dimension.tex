	The dimension describes the number of positional parameters needed to yield an exact solution for a given vector field $V(\vec{x})$, so equals essentially $n = \dim(\vec{x})$. 

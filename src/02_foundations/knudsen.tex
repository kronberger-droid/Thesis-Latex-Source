...
\subsubsection*{Molecular regime (\(Kn \geq 10\))}
	...
	\input{src/02_foundations/fig_velocity-distribution-molecular.tex}
...
\subsubsection*{Slip regime (\(0.001 \leq Kn \leq 0.1\))}
	...
	\input{src/02_foundations/fig_velocity-distribution-slip.tex}
...
\subsubsection*{Continuum regime (\(Kn \leq 0.001\))}
	...
	\input{src/02_foundations/fig_velocity-distribution-continuum.tex}

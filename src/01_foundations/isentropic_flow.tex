	...
	\note{
		Mach number is an important tool since all statevariables can be calculatet using it plus some reference states in the system.
	}	
...
\paragraph{Subsonic regime (\(0.3 < Ma < 1.0\))} 
	...
	\input{src/01_foundations/subsonic.tex}	
...
\paragraph{Supersonic regime (\(Ma > 1\))} 
	...
	\input{src/01_foundations/supersonic.tex}

...
\subsubsection{Continuum regime (\(Kn \leq 0.001\))}
	...
	\input{src/01_foundations/velocity_distribution_continuum.tex}
...
\subsubsection{Slip regime (\(0.001 \leq Kn \leq 0.1\))}
	...
	\input{src/01_foundations/velocity_distribution_slip.tex}
...
\subsubsection{Molecular regime (\(Kn \geq 10\))}
	...
	\input{src/01_foundations/velocity_distribution_molecular.tex}

% src/01_foundations/fig_velocity-distribution-continuum.tex
\begin{figure}[H]
\centering
	...
	\end{tikzpicture}
\caption{Velocity distribution at a point $x$ inside a constant area duct with non-slip boundary conditions. (Continuum flow) \cite{Cengel2017}}

...
\addcontentsline{toc}{subsection}{Thermodynamics}
...
\subsubsection*{Thermal Equations of State}
	...
	\textbf{Ideal gas law}
	\note{
		add different formulations, and check if R
	}
	\begin{equation*}
...
\addcontentsline{toc}{subsection}{Control Volume Analysis}
...
\addcontentsline{toc}{subsection}{Continuous one-dimensional flow}

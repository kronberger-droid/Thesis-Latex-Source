...
\lstinputlisting[label=code:knudsen-plot-py, caption=Generating data for plot of Knudsen and Reynolds numbers for different temperatures and characteristic lengths]{code/plot_data_knudsen_reynolds.py}

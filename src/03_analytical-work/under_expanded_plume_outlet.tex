...
\subsubsection*{Method of characteristics}
	...
	\paragraph*{Determining flow field for free expansion}
		...
		\begin{figure}[H]
		    \centering
		    \includegraphics[width=\textwidth]{src/03_analytical-work/fig_velocity-distribution-reduced.pdf}
			\caption[Method of Characteristics Flow Field Solution \cite{Cassanova1965}]{
				...
				The black curves represent isochor lines, the red curves show rotational freezing for different reservoir pressures, and the blue curves indicate fractions of the total mass flow enclosed between each curve and the $x$-axis. 

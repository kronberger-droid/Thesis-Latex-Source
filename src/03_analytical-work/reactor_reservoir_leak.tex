...
\subsubsection*{Formulations without including the leak}
	...
	\textbf{Isentropic approach}\\
		...
		$$
			\frac{T_r}{T_0} = 0.93\;, \quad \frac{p_r}{p_0} = 0.79\;, \quad \frac{\rho_r}{\rho_0} = 0.85
		$$
	\textbf{Constant temperature approach}\\
		...
		$$
		\note{
			Which corresponds to a massflow of: trough the system. Compare to full isentropic.
		}
		\newpage
...
\subsubsection*{Formulations including the leak}
	...
	$$	
	\note{
		Compare with Mass flow of full isentropic case and for disconnected reservoirs without leak. Maybe not even here but in the chapters themselves.
	}

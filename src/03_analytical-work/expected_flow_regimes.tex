\subsubsection*{Continuum Regime}
	...
	\note{
		...
		Maybe lets not even assume anything but just state that for microfluidics continuum flow with slip is expected and point to later chapter to show that it is true.
	}

...
\note{
	Go more into the solutions. Especially into the non physicality of the high mach numbers inside. Also mention non isentropic processes. Calculate the mass flow for all the points, to check validity.
}

...
\centering
    \begin{tikzpicture}[scale=0.85]
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Values for the dynamic viscosity of nitrogen using the Sutherland formula, with addition of two square-error, best-fits of the Sutherland formula in the range of $200 < T < 600$, one with intercept being forced to zero.}

\subsubsection{Idealized flow regimes}
	...
	In gas dynamics a flow can be categorized by its particle interaction using the Knudsen number, which represents the ratio between the mean-free-path of the gas and some characteristic length.
	$$
		Kn=\frac{\lambda}{l}
	$$
...
\subsubsection{Mach regimes}\todo{add References}
